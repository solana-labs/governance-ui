...
const WizardModeSelect: React.FC<{
  ...
  return (
		<>
			<h2 className="text-center">Create a Decentralized Autonomous Organization (DAO)</h2>
			<div className="grid grid-cols-1 gap-2 text-center ">
				{/* <div className="flex justify-center pointer ">
					...
					>
						...
						<p>Multisig DAO allows you to create an organization for your team members and jointly own and manage shared assets like treasury accounts, NFTs, programs or mints.</p>
					</div>
				</div> */}
				<div className="flex justify-center ">
					...
					>
						...
						<p>Bespoke DAO is an advanced option and allows you to create a DAO customized for your individual requirements, community structure and governance token setup.</p>
					</div>
				</div>
			</div>
			{/* <div className="flex justify-center">
				<a href="https://governance-docs.vercel.app/multisig-DAO/create-multisig-DAO/DAO-wizard" target="_blank" rel="noopener noreferrer">
