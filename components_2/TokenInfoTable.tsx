...
export function TokenInfoCell({ title = '', children }) {
  return (
    <div className="flex flex-col h-full px-5 pt-2 pb-3 space-y-1 rounded-md md:space-y-2 md:pt-5 md:pb-5 md:px-6 bg-night-grey">
      <Text level="2" className="text-white/30">
        {title}
      </Text>
    ...
    >
      ...
      <TokenInfoCell title="Token Symbol">
        <Text className="flex items-center">
          {tokenInfo?.symbol ? (
            <Header as="h4" className="flex items-baseline space-x-2">
