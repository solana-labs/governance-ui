...
import { GovernedMultiTypeAccount, GovernedProgramAccount } from '@utils/tokens'
...
export interface ChangePerpMarketParams2Form {
...
const MakeChangeMaxAccounts = ({
  ...
  const [form, setForm] = useState<ChangePerpMarketParams2Form>({
  ...
  return (
    <>
      {/* if you need more fields add theme to interface ChangePerpMarketParams2Form
