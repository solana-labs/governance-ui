...
const EditCredixDepository = ({
  ...
  const [form, setForm] = useState<UXDEditCredixDepositoryForm>({
  ...
  async function getInstruction(): Promise<UiInstruction> {
    ...
    const ix = client.createEditCredixLpDepositoryInstruction(
...
export default EditCredixDepository
