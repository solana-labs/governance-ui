...
import {
  UiInstruction,
  UXDMintWithMercurialVaultDepositoryForm,
...
const MintWithMercurialVaultDepository = ({
  index,
  governance,
}: {
  index: number
  ...
  const [form, setForm] = useState<UXDMintWithMercurialVaultDepositoryForm>({
...
export default MintWithMercurialVaultDepository
