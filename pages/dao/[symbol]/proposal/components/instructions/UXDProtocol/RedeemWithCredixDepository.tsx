...
import { Controller, USDC, UXD_DECIMALS } from '@uxd-protocol/uxd-client'
...
import {
  UiInstruction,
  UXDRedeemWithCredixDepositoryForm,
...
const RedeemWithCredixDepository = ({
  index,
  governance,
}: {
  index: number
  ...
  const [form, setForm] = useState<UXDRedeemWithCredixDepositoryForm>({
  ...
  async function getInstruction(): Promise<UiInstruction> {
    ...
    const ix = client.createRedeemFromCredixLpDepositoryInstruction(
...
export default RedeemWithCredixDepository
